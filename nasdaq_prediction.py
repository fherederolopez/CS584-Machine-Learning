...
df = pd.read_csv(r"C:\Users\mende\OneDrive\Escritorio\CS584 - Machine Learning\Project\NASDAQ Composite Historical Data.csv")
...
# Load our model
model = load_model(r"C:\Users\mende\OneDrive\Escritorio\CS584 - Machine Learning\Project\model.h5")
