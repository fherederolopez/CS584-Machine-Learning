...
df = pd.read_csv(r"C:\Users\augus\Documents\Chicago\IIT\CS 584 - Machine Learning\Project\S&P 500 Historical Data V2.csv")
...
eur = pd.read_csv(r"C:\Users\augus\Documents\Chicago\IIT\CS 584 - Machine Learning\Project\europe_cases.csv")
...
deaths = data["eur_deaths"][:180].reset_index()
...
# LOAD SCALER
scaler = joblib.load(r"C:\Users\augus\Documents\Chicago\IIT\CS 584 - Machine Learning\Project\scaler.save")

scaled = scaler.fit_transform(data)
scaled_data = pd.DataFrame(scaled, columns=data.columns)

# NEW DEATH VALUES - PESSIMISTIC (double than the first covid wave) 
scaled_data["eur_deaths"] = scaled_data["eur_deaths"]
...
model = load_model(r"C:\Users\augus\Documents\Chicago\IIT\CS 584 - Machine Learning\Project\model.h5")
...
plt.title("S&P 500 value - Possible pessimist scenario")
plt.show()
